...
---
### 이 문제는 2가지 방법으로 해결하였던 문제입니다.
        1. 전형적인 스택을 이용한 방법
        2. 스택의 원리만 이용하여 구현한 방법.
*현재 "같은 숫자는 싫어.py"는 2번 방법으로 구현된 것입니다.* 만약, 1번 방법으로 작성한 코드를 보고 싶으시면 해당 파일의 Histroy를 참고해주세요.<br>
++추가.
2번으로 작성한 파일을 최종 파일로 설정해 놓은 이유는 조금 더 코드의 길이가 짧고 간결하기 때문입니다.
---
