...
---
- 2차원 dp 함수를 만들어서 제작. 단, 0과 1의 경우에는 일반식 도출이 힘들어서 그냥 하드 코딩으로 구현.
- 옛날에는 상상도 못한 풀이 방식으로 풀어서 기분 좋음.
- 첫 제출 시 IndexError 발생 -> 2차원 dp 배열의 길이를 늘림으로써 해결.
---
